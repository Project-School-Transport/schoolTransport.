    ...
    return (
        < div className="displayStudent">
           ...
           <li className="table-row">
             ...
             <div className="col col-1" data-label="Job Id">{students.user.username}</div>
            ...
            <div className="col col-1" data-label="Payment Status"> <button className="field" onClick={deleteStudent}> Delete </button> </div>
           </li>  
