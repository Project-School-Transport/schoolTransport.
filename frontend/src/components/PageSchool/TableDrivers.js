...
<Popup trigger={<button className="field"> Add Student  </button>} modal>
  ...
  <label className="labelFrom" for="fname"> Id Student:</label>
  <input type="email" id="email" name="text" 
        onChange={e => {
          setAddStudent({ ...addStudent, studentId: e.target.value });
        }} /> 
  <label className="labelFrom" for="lname">Id driver:</label>
 ...
 <button className="field addFrom" onClick={(e)=>AddStudent (e)} > Add </button>
</form>
  </Popup>
